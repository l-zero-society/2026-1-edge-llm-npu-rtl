...
VL_ATTR_COLD void VRopeUnit___024root___eval_triggers__stl(VRopeUnit___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRopeUnit___024root___eval_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void VRopeUnit___024root___stl_sequent__TOP__0(VRopeUnit___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRopeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRopeUnit___024root___stl_sequent__TOP__0\n"); );
    // Init
...
VL_ATTR_COLD void VRopeUnit___024root___stl_sequent__TOP__1(VRopeUnit___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRopeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRopeUnit___024root___stl_sequent__TOP__1\n"); );
    // Body
...
VL_ATTR_COLD void VRopeUnit___024root___eval_stl(VRopeUnit___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRopeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRopeUnit___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        VRopeUnit___024root___stl_sequent__TOP__0(vlSelf);
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_0));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_1));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_2));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_3));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_4));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_5));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_6));
        VRopeUnit_RopePairCore___stl_sequent__TOP__RopeUnit__DOT__pairs_0__0((&vlSymsp->TOP__RopeUnit__DOT__pairs_7));
        VRopeUnit___024root___stl_sequent__TOP__1(vlSelf);
    }
}
