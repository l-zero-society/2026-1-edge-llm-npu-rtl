...
#ifndef VERILATED_VROPEUNIT_ROPEPAIRCORE_H_
#define VERILATED_VROPEUNIT_ROPEPAIRCORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VRopeUnit_RopePairCore final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VRopeUnit_RopePairCore(VRopeUnit__Syms* symsp, const char* v__name);
    ~VRopeUnit_RopePairCore();
    VL_UNCOPYABLE(VRopeUnit_RopePairCore);
