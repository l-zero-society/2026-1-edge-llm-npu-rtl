...
#ifndef VERILATED_VCOMPUTEUNIT_QUANTACTCORE_H_
#define VERILATED_VCOMPUTEUNIT_QUANTACTCORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VComputeUnit_QuantActCore final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VComputeUnit_QuantActCore(VComputeUnit__Syms* symsp, const char* v__name);
    ~VComputeUnit_QuantActCore();
    VL_UNCOPYABLE(VComputeUnit_QuantActCore);
