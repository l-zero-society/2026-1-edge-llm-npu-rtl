...
VL_ATTR_COLD void VComputeUnit_RopePairCore___stl_sequent__TOP__ComputeUnit__DOT__vpu2__DOT__rope__DOT__pairs_0__0(VComputeUnit_RopePairCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnit_RopePairCore___stl_sequent__TOP__ComputeUnit__DOT__vpu2__DOT__rope__DOT__pairs_0__0\n"); );
    // Init
