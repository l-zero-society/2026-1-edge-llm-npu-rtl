...
VL_ATTR_COLD void VComputeUnit_QuantActCore___stl_sequent__TOP__ComputeUnit__DOT__vpu1__DOT__quant__DOT__cores_0__0(VComputeUnit_QuantActCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnit_QuantActCore___stl_sequent__TOP__ComputeUnit__DOT__vpu1__DOT__quant__DOT__cores_0__0\n"); );
    // Body
...
VL_ATTR_COLD void VComputeUnit_QuantActCore___stl_sequent__TOP__ComputeUnit__DOT__vpu1__DOT__quant__DOT__cores_1__0(VComputeUnit_QuantActCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnit_QuantActCore___stl_sequent__TOP__ComputeUnit__DOT__vpu1__DOT__quant__DOT__cores_1__0\n"); );
    // Body
    vlSelf->__VdfgTmp_h017163a2__0 = (((QData)((IData)(
                                                       (1U 
                                                        & (IData)(
