...
#ifndef VERILATED_VCOMPUTEUNIT_UNIVERSAL_WIDE_LUT_16_H_
#define VERILATED_VCOMPUTEUNIT_UNIVERSAL_WIDE_LUT_16_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VComputeUnit_Universal_Wide_LUT_16 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VComputeUnit_Universal_Wide_LUT_16(VComputeUnit__Syms* symsp, const char* v__name);
    ~VComputeUnit_Universal_Wide_LUT_16();
    VL_UNCOPYABLE(VComputeUnit_Universal_Wide_LUT_16);
