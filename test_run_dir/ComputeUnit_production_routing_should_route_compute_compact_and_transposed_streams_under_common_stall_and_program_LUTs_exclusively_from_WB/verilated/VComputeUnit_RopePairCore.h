...
#ifndef VERILATED_VCOMPUTEUNIT_ROPEPAIRCORE_H_
#define VERILATED_VCOMPUTEUNIT_ROPEPAIRCORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VComputeUnit_RopePairCore final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VComputeUnit_RopePairCore(VComputeUnit__Syms* symsp, const char* v__name);
    ~VComputeUnit_RopePairCore();
    VL_UNCOPYABLE(VComputeUnit_RopePairCore);
