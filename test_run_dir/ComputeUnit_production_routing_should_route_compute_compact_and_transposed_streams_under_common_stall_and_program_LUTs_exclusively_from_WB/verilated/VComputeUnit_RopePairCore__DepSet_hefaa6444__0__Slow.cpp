...
VL_ATTR_COLD void VComputeUnit_RopePairCore___ctor_var_reset(VComputeUnit_RopePairCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnit_RopePairCore___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VComputeUnit_RopePairCore___configure_coverage(VComputeUnit_RopePairCore* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnit_RopePairCore___configure_coverage\n"); );
    // Body
