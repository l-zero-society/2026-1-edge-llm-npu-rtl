...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_ONLINE_mode_should_run_Milakov_online_Softmax_while_interleaving_nextrow_Phase1_with_priorrow_Phase2/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_ONLINE_mode_should_run_Milakov_online_Softmax_while_interleaving_nextrow_Phase1_with_priorrow_Phase2/UniversalNormUnit.)";
