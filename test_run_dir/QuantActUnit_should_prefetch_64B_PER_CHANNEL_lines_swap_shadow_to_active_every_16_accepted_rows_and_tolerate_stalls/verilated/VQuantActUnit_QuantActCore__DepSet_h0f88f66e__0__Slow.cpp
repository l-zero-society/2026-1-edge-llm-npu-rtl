...
VL_ATTR_COLD void VQuantActUnit_QuantActCore___ctor_var_reset(VQuantActUnit_QuantActCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VQuantActUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VQuantActUnit_QuantActCore___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VQuantActUnit_QuantActCore___configure_coverage(VQuantActUnit_QuantActCore* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VQuantActUnit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VQuantActUnit_QuantActCore___configure_coverage\n"); );
    // Body
