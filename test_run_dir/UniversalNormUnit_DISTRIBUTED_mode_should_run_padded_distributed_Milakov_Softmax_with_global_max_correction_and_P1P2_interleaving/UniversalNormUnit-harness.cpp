...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_DISTRIBUTED_mode_should_run_padded_distributed_Milakov_Softmax_with_global_max_correction_and_P1P2_interleaving/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_DISTRIBUTED_mode_should_run_padded_distributed_Milakov_Softmax_with_global_max_correction_and_P1P2_interleaving/UniversalNormUnit.)";
