...
VL_ATTR_COLD void VTPU_top_Accum_buffer___ctor_var_reset(VTPU_top_Accum_buffer* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTPU_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTPU_top_Accum_buffer___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VTPU_top_Accum_buffer___configure_coverage(VTPU_top_Accum_buffer* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VTPU_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTPU_top_Accum_buffer___configure_coverage\n"); );
    // Body
