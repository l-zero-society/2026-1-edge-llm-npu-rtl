...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_assert_row_change_on_every_tile_when_outColNum_is_one/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_assert_row_change_on_every_tile_when_outColNum_is_one/TPU_top.)";
