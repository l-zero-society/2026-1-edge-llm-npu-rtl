...
#ifndef VERILATED_VCOMPUTEUNITE2EHARNESS_QUANTACTCORE_H_
#define VERILATED_VCOMPUTEUNITE2EHARNESS_QUANTACTCORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VComputeUnitE2EHarness_QuantActCore final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VComputeUnitE2EHarness_QuantActCore(VComputeUnitE2EHarness__Syms* symsp, const char* v__name);
    ~VComputeUnitE2EHarness_QuantActCore();
    VL_UNCOPYABLE(VComputeUnitE2EHarness_QuantActCore);
