...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_DISTRIBUTED_mode_should_preserve_distributed_Softmax_correction_and_Phase2_state_across_targeted_and_random_stalls/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_DISTRIBUTED_mode_should_preserve_distributed_Softmax_correction_and_Phase2_state_across_targeted_and_random_stalls/UniversalNormUnit.)";
