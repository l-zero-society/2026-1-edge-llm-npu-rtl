...
VL_ATTR_COLD void VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__streamExpLuts_0__0(VComputeUnitE2EHarness_Universal_Wide_LUT_16* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__streamExpLuts_0__0\n"); );
    // Body
...
VL_ATTR_COLD void VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__streamExpLuts_2__0(VComputeUnitE2EHarness_Universal_Wide_LUT_16* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__streamExpLuts_2__0\n"); );
    // Body
    vlSelf->__PVT___GEN_12 = ((IData)(vlSelf->__PVT__is_programmed) 
                              | (IData)(vlSelf->__PVT__last_write_ack));
    vlSelf->io_rd_data = ((7U == (IData)(vlSelf->__PVT__rd_col_delayed))
...
VL_ATTR_COLD void VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__correctionExpLuts_0__0(VComputeUnitE2EHarness_Universal_Wide_LUT_16* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_Universal_Wide_LUT_16___stl_sequent__TOP__ComputeUnitE2EHarness__DOT__vpu2__DOT__norm__DOT__correctionExpLuts_0__0\n"); );
    // Body
    vlSelf->__PVT___GEN_12 = ((IData)(vlSelf->__PVT__is_programmed) 
                              | (IData)(vlSelf->__PVT__last_write_ack));
}

VL_ATTR_COLD void VComputeUnitE2EHarness_Universal_Wide_LUT_16___ctor_var_reset(VComputeUnitE2EHarness_Universal_Wide_LUT_16* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_Universal_Wide_LUT_16___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VComputeUnitE2EHarness_Universal_Wide_LUT_16___configure_coverage(VComputeUnitE2EHarness_Universal_Wide_LUT_16* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_Universal_Wide_LUT_16___configure_coverage\n"); );
    // Body
