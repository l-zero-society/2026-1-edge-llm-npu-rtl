...
#ifndef VERILATED_VCOMPUTEUNITE2EHARNESS_ACCUM_BUFFER_H_
#define VERILATED_VCOMPUTEUNITE2EHARNESS_ACCUM_BUFFER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VComputeUnitE2EHarness_Accum_buffer final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VComputeUnitE2EHarness_Accum_buffer(VComputeUnitE2EHarness__Syms* symsp, const char* v__name);
    ~VComputeUnitE2EHarness_Accum_buffer();
    VL_UNCOPYABLE(VComputeUnitE2EHarness_Accum_buffer);
