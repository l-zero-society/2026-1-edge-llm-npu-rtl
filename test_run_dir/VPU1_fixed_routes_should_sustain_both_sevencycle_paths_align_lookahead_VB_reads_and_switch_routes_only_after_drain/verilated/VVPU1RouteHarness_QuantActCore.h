...
#ifndef VERILATED_VVPU1ROUTEHARNESS_QUANTACTCORE_H_
#define VERILATED_VVPU1ROUTEHARNESS_QUANTACTCORE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VVPU1RouteHarness_QuantActCore final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VVPU1RouteHarness_QuantActCore(VVPU1RouteHarness__Syms* symsp, const char* v__name);
    ~VVPU1RouteHarness_QuantActCore();
    VL_UNCOPYABLE(VVPU1RouteHarness_QuantActCore);
