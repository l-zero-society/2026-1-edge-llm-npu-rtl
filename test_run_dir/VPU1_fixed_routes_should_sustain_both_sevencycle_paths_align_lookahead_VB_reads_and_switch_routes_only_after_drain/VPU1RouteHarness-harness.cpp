...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/VPU1_fixed_routes_should_sustain_both_sevencycle_paths_align_lookahead_VB_reads_and_switch_routes_only_after_drain/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/VPU1_fixed_routes_should_sustain_both_sevencycle_paths_align_lookahead_VB_reads_and_switch_routes_only_after_drain/VPU1RouteHarness.)";
