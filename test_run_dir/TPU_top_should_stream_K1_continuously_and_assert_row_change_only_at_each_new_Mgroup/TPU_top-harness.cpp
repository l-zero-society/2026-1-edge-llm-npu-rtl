...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_stream_K1_continuously_and_assert_row_change_only_at_each_new_Mgroup/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_stream_K1_continuously_and_assert_row_change_only_at_each_new_Mgroup/TPU_top.)";
