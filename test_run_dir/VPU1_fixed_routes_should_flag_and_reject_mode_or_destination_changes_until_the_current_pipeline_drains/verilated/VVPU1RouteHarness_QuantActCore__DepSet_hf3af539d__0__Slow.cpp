...
VL_ATTR_COLD void VVPU1RouteHarness_QuantActCore___ctor_var_reset(VVPU1RouteHarness_QuantActCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VVPU1RouteHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVPU1RouteHarness_QuantActCore___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VVPU1RouteHarness_QuantActCore___configure_coverage(VVPU1RouteHarness_QuantActCore* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VVPU1RouteHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVPU1RouteHarness_QuantActCore___configure_coverage\n"); );
    // Body
