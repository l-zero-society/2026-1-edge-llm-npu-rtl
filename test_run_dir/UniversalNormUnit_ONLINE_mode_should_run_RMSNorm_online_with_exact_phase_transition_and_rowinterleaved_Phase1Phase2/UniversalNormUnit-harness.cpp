...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_ONLINE_mode_should_run_RMSNorm_online_with_exact_phase_transition_and_rowinterleaved_Phase1Phase2/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/UniversalNormUnit_ONLINE_mode_should_run_RMSNorm_online_with_exact_phase_transition_and_rowinterleaved_Phase1Phase2/UniversalNormUnit.)";
