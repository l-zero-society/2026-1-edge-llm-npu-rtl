...
VL_ATTR_COLD void VComputeUnitE2EHarness_QuantActCore___ctor_var_reset(VComputeUnitE2EHarness_QuantActCore* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_QuantActCore___ctor_var_reset\n"); );
    // Body
...
VL_ATTR_COLD void VComputeUnitE2EHarness_QuantActCore___configure_coverage(VComputeUnitE2EHarness_QuantActCore* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VComputeUnitE2EHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VComputeUnitE2EHarness_QuantActCore___configure_coverage\n"); );
    // Body
