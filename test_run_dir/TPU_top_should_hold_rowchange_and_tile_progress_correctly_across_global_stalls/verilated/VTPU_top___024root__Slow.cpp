...
void VTPU_top___024root___configure_coverage(VTPU_top___024root* vlSelf, bool first);

void VTPU_top___024root::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    VTPU_top___024root___configure_coverage(this, first);
}
...
// Coverage
void VTPU_top___024root::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
