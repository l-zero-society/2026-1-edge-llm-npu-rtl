...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_hold_rowchange_and_tile_progress_correctly_across_global_stalls/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/workspace/lzero_01_rtl/test_run_dir/TPU_top_should_hold_rowchange_and_tile_progress_correctly_across_global_stalls/TPU_top.)";
