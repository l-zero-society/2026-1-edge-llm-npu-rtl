...
#ifndef VERILATED_VTPU_TOP_ACCUM_BUFFER_H_
#define VERILATED_VTPU_TOP_ACCUM_BUFFER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VTPU_top_Accum_buffer final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VTPU_top_Accum_buffer(VTPU_top__Syms* symsp, const char* v__name);
    ~VTPU_top_Accum_buffer();
    VL_UNCOPYABLE(VTPU_top_Accum_buffer);
